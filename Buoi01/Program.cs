    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] ms = { "1. Xem danh sách sinh viên", "2. Thêm sinh viên mới",
                ...
                "6. Cập nhật danh sách vào file", "7. Xem danh sách sinh viên theo chuyên ngành",
                "8. Xem điểm bình quân của tất cả sinh viên", "9. Xem danh sách sinh viên học lại", "0. Thoát" };
            ...
            do
            {
                ...
                switch (chon)
                {
                    ...
                    case 7:
                        {
                            Console.Write(" Nhập chuyên ngành mà bạn muốn hiển thị danh sách sinh viên: ");
                            string cn = Console.ReadLine();
                            ds.DsChuyenNghanh(cn);
                            break;
                        }
                    case 8:
                        {
                            Console.WriteLine(" Điểm bình quân của sinh viên là : {0:0.00}", ds.DiemAVG());
                            break;
                        }
                    case 9:
                        {
                            Console.WriteLine(" Danh sách các sinh viên học lại : ");
                            ds.DsHoclai();
                            break;
                        }
                }
